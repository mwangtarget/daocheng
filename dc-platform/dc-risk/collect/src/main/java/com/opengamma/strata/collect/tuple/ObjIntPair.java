...
public final class ObjIntPair<A>
    implements ImmutableBean, Tuple, Comparable<ObjIntPair<A>>, Serializable {
  ...
  public static <A> ObjIntPair<A> ofPair(Pair<A, Integer> pair) {
    ...
    return new ObjIntPair<A>(pair.getFirst(), pair.getSecond());
  }
  ...
  public String toString() {
    ...
    ///CLOVER:OFF
    /**
     * The meta-bean for {@code ObjIntPair}.
    ...
    static {
        JodaBeanUtils.registerMetaBean(ObjIntPair.Meta.INSTANCE);
    }
    ...
    public static final class Meta<A> extends DirectMetaBean {
        ...
        private final MetaProperty<A> first = (DirectMetaProperty) DirectMetaProperty.ofImmutable(
                this, "first", ObjIntPair.class, Object.class);
        /**
         * The meta-property for the {@code second} property.
         */
        private final MetaProperty<Integer> second = DirectMetaProperty.ofImmutable(
                this, "second", ObjIntPair.class, Integer.TYPE);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public BeanBuilder<? extends ObjIntPair<A>> builder() {
            return new ObjIntPair.Builder<A>();
        }

        @SuppressWarnings({"unchecked", "rawtypes" })
        @Override
        public Class<? extends ObjIntPair<A>> beanType() {
            return (Class) ObjIntPair.class;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Integer> second() {
            return second;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 97440432:  // first
                    return ((ObjIntPair<?>) bean).getFirst();
                case -906279820:  // second
                    return ((ObjIntPair<?>) bean).getSecond();
            }
    ...
    //-----------------------------------------------------------------------
    /**
     * The bean-builder for {@code ObjIntPair}.
     * @param <A>  the type
     */
    private static final class Builder<A> extends DirectFieldsBeanBuilder<ObjIntPair<A>> {
        ...
        @Override
        public ObjIntPair<A> build() {
            return new ObjIntPair<A>(
                    first,
                    second);
        }
