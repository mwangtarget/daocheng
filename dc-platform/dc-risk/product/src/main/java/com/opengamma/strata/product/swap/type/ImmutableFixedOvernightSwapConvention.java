 ...
 */
@BeanDefinition
public final class ImmutableFixedOvernightSwapConvention
    implements FixedOvernightSwapConvention, ImmutableBean, Serializable {
  ...
  public String toString() {
    ...
    static {
        JodaBeanUtils.registerMetaBean(ImmutableFixedOvernightSwapConvention.Meta.INSTANCE);
    }
    ...
    private ImmutableFixedOvernightSwapConvention(
            String name,
            FixedRateSwapLegConvention fixedLeg,
            OvernightRateSwapLegConvention floatingLeg,
            DaysAdjustment spotDateOffset) {
    ...
    public static final class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<String> name = DirectMetaProperty.ofImmutable(
                this, "name", ImmutableFixedOvernightSwapConvention.class, String.class);
        /**
        ...
        private final MetaProperty<FixedRateSwapLegConvention> fixedLeg = DirectMetaProperty.ofImmutable(
                this, "fixedLeg", ImmutableFixedOvernightSwapConvention.class, FixedRateSwapLegConvention.class);
        /**
        ...
        private final MetaProperty<OvernightRateSwapLegConvention> floatingLeg = DirectMetaProperty.ofImmutable(
                this, "floatingLeg", ImmutableFixedOvernightSwapConvention.class, OvernightRateSwapLegConvention.class);
        /**
        ...
        private final MetaProperty<DaysAdjustment> spotDateOffset = DirectMetaProperty.ofImmutable(
                this, "spotDateOffset", ImmutableFixedOvernightSwapConvention.class, DaysAdjustment.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public ImmutableFixedOvernightSwapConvention.Builder builder() {
            return new ImmutableFixedOvernightSwapConvention.Builder();
        }

        @Override
        public Class<? extends ImmutableFixedOvernightSwapConvention> beanType() {
            return ImmutableFixedOvernightSwapConvention.class;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 3373707:  // name
                    return ((ImmutableFixedOvernightSwapConvention) bean).getName();
                case -391537158:  // fixedLeg
                    return ((ImmutableFixedOvernightSwapConvention) bean).getFixedLeg();
                case -1177101272:  // floatingLeg
                    return ((ImmutableFixedOvernightSwapConvention) bean).getFloatingLeg();
                case 746995843:  // spotDateOffset
                    return ((ImmutableFixedOvernightSwapConvention) bean).getSpotDateOffset();
            }
     ...
     */
    public static final class Builder extends DirectFieldsBeanBuilder<ImmutableFixedOvernightSwapConvention> {
         ...
         */
        private Builder(ImmutableFixedOvernightSwapConvention beanToCopy) {
        ...
        public ImmutableFixedOvernightSwapConvention build() {
            return new ImmutableFixedOvernightSwapConvention(
                    name,
                    fixedLeg,
                    floatingLeg,
                    spotDateOffset);
