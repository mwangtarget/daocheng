 ...
 * <p>
 * This is the resolved form of {@link SwaptionTrade} and is the primary input to the pricers.
 * Applications will typically create a {@code ResolvedSwaptionTrade} from a {@code SwaptionTrade}
 * using {@link SwaptionTrade#resolve(ReferenceData)}.
 * <p>
...
public final class ResolvedSwaptionTrade
  ...
  private final ResolvedSwaption product;
  /**
  ...
  private static void applyDefaults(Builder builder) {
    ...
    static {
        JodaBeanUtils.registerMetaBean(ResolvedSwaptionTrade.Meta.INSTANCE);
    }
    ...
    public static final class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<TradeInfo> info = DirectMetaProperty.ofImmutable(
                this, "info", ResolvedSwaptionTrade.class, TradeInfo.class);
        /**
         * The meta-property for the {@code product} property.
         */
        private final MetaProperty<ResolvedSwaption> product = DirectMetaProperty.ofImmutable(
                this, "product", ResolvedSwaptionTrade.class, ResolvedSwaption.class);
        /**
         * The meta-property for the {@code premium} property.
         */
        private final MetaProperty<Payment> premium = DirectMetaProperty.ofImmutable(
                this, "premium", ResolvedSwaptionTrade.class, Payment.class);
        /**
         * The meta-properties.
         */
        ...
        public Class<? extends ResolvedSwaptionTrade> beanType() {
            return ResolvedSwaptionTrade.class;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case 3237038:  // info
                    return ((ResolvedSwaptionTrade) bean).getInfo();
                case -309474065:  // product
                    return ((ResolvedSwaptionTrade) bean).getProduct();
                case -318452137:  // premium
                    return ((ResolvedSwaptionTrade) bean).getPremium();
            }
     ...
     */
    public static final class Builder extends DirectFieldsBeanBuilder<ResolvedSwaptionTrade> {

        private TradeInfo info;
        private ResolvedSwaption product;
         ...
         */
        private Builder(ResolvedSwaptionTrade beanToCopy) {
        ...
        public Builder set(String propertyName, Object newValue) {
            switch (propertyName.hashCode()) {
                case 3237038:  // info
                    ...
                    break;
                case -309474065:  // product
                    this.product = (ResolvedSwaption) newValue;
                    break;
                case -318452137:  // premium
        ...
        public ResolvedSwaptionTrade build() {
            return new ResolvedSwaptionTrade(
                    info,
                    product,
                    premium);
        }
