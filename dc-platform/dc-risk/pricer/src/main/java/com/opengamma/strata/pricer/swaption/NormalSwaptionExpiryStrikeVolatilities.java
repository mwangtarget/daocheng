...
public final class NormalSwaptionExpiryStrikeVolatilities
  ...
  public double tenor(LocalDate startDate, LocalDate endDate) {
    ...
    static {
        JodaBeanUtils.registerMetaBean(NormalSwaptionExpiryStrikeVolatilities.Meta.INSTANCE);
    }
     ...
     */
    private static final class Builder extends DirectFieldsBeanBuilder<NormalSwaptionExpiryStrikeVolatilities> {
